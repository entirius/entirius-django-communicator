...
class Suppression(BaseModel):
    """Never contact this email, or anyone at this registrable domain (`value` stored lower-cased)."""

    channel = models.ForeignKey("django_communicator.Channel", on_delete=models.CASCADE, related_name="suppressions")
